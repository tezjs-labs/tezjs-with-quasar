<template>
  <div class="">
                    ...
                    <div>
                        <div class="row ">
                            <div class="col-sm-11 col-12 q-mt-lg">
                                <span class="text-blue-grey-5"> Copyright © 2022 TezJS.</span>
                                <span class="text-blue-grey-1 text-h5  "> | </span>
                            </div>
                            <div class="col-sm-1 co-12 row q-mt-lg justify-end">
                                <a
